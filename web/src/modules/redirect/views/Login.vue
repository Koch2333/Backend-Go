...
const target = () => (route.query.from as string) || '/m/redirect/rules'
...
async function onSubmit() {
  ...
  try {
    ...
    REDIRECT.useAuth().set(r.token!, r.username!, r.expiresAt!)
...
<template>
  <main class="flex min-h-screen items-center justify-center bg-gray-100 px-6">
    <div class="w-full max-w-sm rounded-2xl bg-white p-6 shadow">
      <h1 class="text-center text-base font-semibold text-gray-800">Redirect 后台</h1>
